...
function newAnobiiParser() {
    ...
    return {
        ...
        getShelfURL: function(homeBody) {
            return $(homeBody)(Selectors.SHELF)[0].attribs.href;
        },

        getPersonId: function(shelfBody) {
            return $(shelfBody)(Selectors.PERSON).val();
        },
        
        getLastPage: function(shelfBody) {
            return $(shelfBody)(Selectors.LAST_PAGE).last().text().trim();
        },
